...
# bodyアイテムがない場合
execute unless items entity @s armor.body *[equippable={"slot": "body",equip_sound:intentionally_empty}] run item replace entity @s armor.body with stone[equippable={slot:body,equip_sound:intentionally_empty},enchantments={binding_curse:1}]
