...
execute if score $y_ hb.Motion matches ..-1 run data modify storage hb:motion macro.signy set value "-y"
execute if data storage hb:motion macro{signy:"-y"} run scoreboard players operation $y_ hb.Motion *= #-1 hb.Motion
...
execute if score $z_ hb.Motion matches ..-1 run data modify storage hb:motion macro.signz set value "-z"
execute if data storage hb:motion macro{signz:"-z"} run scoreboard players operation $z_ hb.Motion *= #-1 hb.Motion
